...
/*   Updated: 2025/11/17 16:30:29 by dev              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
    ...
    my = ft_printf("ft : c=%c s=%s null_s=%s p=%p p0=%p d=%d i=%i u=%u x=%x X=%X %% int_max=%d int_min=%d uint_max=%u\n",
                   c, s, s_null, p, p_null,
                   d_neg, d_pos, u_big, x_val, x_val,
                   d_int_max, d_int_min, u_uint_max);
    org = printf("org: c=%c s=%s null_s=%s p=%p p0=%p d=%d i=%i u=%u x=%x X=%X %% int_max=%d int_min=%d uint_max=%u\n",
                 c, s, s_null, p, p_null,
                 d_neg, d_pos, u_big, x_val, x_val,
                 d_int_max, d_int_min, u_uint_max);
    printf("ret: ft=%d org=%d\n\n", my, org);
